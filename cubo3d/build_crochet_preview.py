...
MESHES = [
    ("cuerpo_crochet.stl", [0.95, 0.80, 0.16], 130000, True),   # amarillo
...
HTML = """<div id="wrap">
  <canvas id="c"></canvas>
  <div id="hud">
    <div class="row"><b>Bloki lana</b> — arrastra para rotar · rueda para zoom</div>
...
Path("preview_crochet.html").write_text(HTML, encoding="utf-8")
kb = len(HTML.encode()) / 1024
print(f"Guardado preview_crochet.html ({kb:.0f} KB)")
