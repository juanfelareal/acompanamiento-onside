...
TEX = [("chaflan_ranurado", "A · Chaflan (sentadito)"), ("cajita_ranurado", "B · Cajita (bloque)")]
...
fig.suptitle("Bloki terminado — formas de base (cuerpo + cara + ojos)",
             color="w", fontsize=17, y=0.99)
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig("formas_ensamblado.png", dpi=125, facecolor="#111",
            bbox_inches="tight")
print("Guardado formas_ensamblado.png")
