...
BODIES = [
    ("chaflan", "cuerpo_chaflan_ranurado.stl", 135000),
    ("cajita",  "cuerpo_cajita_ranurado.stl",  135000),
]
YEL = [0.95, 0.80, 0.16]
...
HTML = r"""<div id="wrap">
  ...
  <div id="hud">
    ...
    <div class="row">
      <button id="b0" class="tx on">A · Chaflán</button>
      <button id="b1" class="tx">B · Cajita</button>
    </div>
    <div class="row">
...
Path("preview_formas.html").write_text(HTML, encoding="utf-8")
print(f"Guardado preview_formas.html ({len(HTML.encode())/1024/1024:.1f} MB)")
